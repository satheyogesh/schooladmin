...
<%@ taglib uri="http://java.sun.com/jsp/jstl/core" prefix="c" %>
	<%@ taglib uri="http://java.sun.com/jsp/jstl/fmt" prefix="fmt" %> <%@ page
			...
			pageEncoding="ISO-8859-1" %> <%@ page import="java.io.*,java.util.*" %>
				<%@ page import="javax.servlet.*,java.text.*" %> <html>
												...
												<tbody>
													<c:forEach var="task" items="${tasks}">
														<tr>
															<td>${task.task}</td>
															<td>
																<fmt:formatDate value="${task.dt}" type="date"
																	pattern="MM/dd/yyyy" />
																</td>
																<td>
																	<c:if test="${task.finished eq true}">Yes</c:if>
																	<c:if test="${task.finished eq false}">No</c:if>
																</td>
																<td><a href="update-task?id=${task.id}"><span class="glyphicon
																			glyphicon-pencil"></span></a></td>
																<td><a href="delete-task?id=${task.id}"><span class="glyphicon
											...
											<form method="post" action="save-task">
												...
												<div class="form-group">
													...
													<div class="col-md-7">
														...
														<c:if test="${taskObj.finished eq true}">
														...
														<c:if test="${taskObj.finished eq false}">
